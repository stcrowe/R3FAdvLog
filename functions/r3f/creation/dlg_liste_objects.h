...
class R3F_LOG_dlg_liste_objects
{
	...
	onLoad = "systemChat format ['%1', R3F_LOG_IDD_dlg_liste_objects];";

	onUnload = "[] call AdvLog_fnc_storeListObj;";
	...
	class R3F_LOG_dlg_LO_liste_categories : R3F_LOG_dlg_LO_liste
	{
		...
		onLBSelChanged = "[] call AdvLog_fnc_factoryCompleteList;";
	};
	...
	class R3F_LOG_dlg_LO_liste_objects : R3F_LOG_dlg_LO_liste
	{
		...
		onLBDblClick = "[] spawn AdvLog_fnc_factoryCreateObj;";
		onLBSelChanged = "[(_this select 0) lbData (_this select 1)] call R3F_LOG_VIS_FNCT_voir_object;";
	};
	...
	class R3F_LOG_dlg_LO_btn_creer : R3F_LOG_dlg_LO_btn
	{
		...
		text = "";
		action = "0 spawn AdvLog_fnc_factoryCreateObj;";
	};
